...
\textbf{Parallel constraints arise in real-world systems, forcing reliance on memory for complex computation.}
...
\textbf{Neural architectures are fundamentally parallel, imposing hard limits on sequential computation.}
...
\textbf{Additional memory mechanisms---like recurrent connections and attention---enable sequential logic in parallel networks.}
...
\textbf{Cells face parallel constraints due to molecular diffusion and simultaneous biochemical reactions.}
...
\textbf{DNA-based record-keeping, epigenetics, and neural time cells exemplify how evolution converged on memory to enable sequential processing.}
...
\textbf{Ultimately, enhanced memory---across domains---provides the cornerstone for circumventing parallel limitations.}
