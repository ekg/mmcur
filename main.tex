...
This explains how language models achieve step-by-step reasoning: not through complex computational architectures, but by learning to use language itself as a memory system.
