...
Biological systems show similar patterns: cells partition computation through cell cycle phases and stable epigenetic states \cite{bruno2022epigenetic}, while developing organisms maintain state through precisely timed developmental stages and morphology \cite{turing1990chemical}.
...
Developing organisms also record state through their morphology and self-enhancing molecular networks---a principle first formalized by Turing's reaction-diffusion theory \cite{turing1990chemical}.
