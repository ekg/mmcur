...
Recent advances in molecular recording systems further illustrate this principle.
The TRACE system uses CRISPR arrays as "biological tape" to record temporal signals directly into bacterial genomes \cite{sheth2017multiplex}, while DNA Typewriter enables sequential genome editing to record complex event histories \cite{choi2022time}.
These systems achieve sophisticated information storage through simple molecular mechanisms---CRISPR spacer acquisition and prime editing respectively---combined with clever state maintenance schemes.
The DMOS system demonstrates how even digital data can be stored through targeted mutations using CRISPR base editors \cite{sadremomtaz2023digital}, showing how basic biological processes can implement complex memory systems when properly organized.
