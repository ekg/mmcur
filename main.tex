...
Neural architectures are fundamentally parallel, imposing hard limits on sequential computation.
...
Cells face parallel constraints due to molecular diffusion and simultaneous biochemical reactions.

Like neural networks, biological processes cannot easily run "step-by-step" in a physical sense.
