...
We began as collections of cells that evolved increasingly sophisticated ways to remember.
At the most fundamental level, the genome acts as computational state, maintained through an unbroken chain of survival.
Then came molecular markers that help cells maintain their identity.
Later, immune systems evolved to learn from encounters.
Finally, neural architectures emerged that somehow give rise to consciousness.
