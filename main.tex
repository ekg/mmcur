...
Instead, we're engaging with a computational process that builds up complex reasoning through recursive state refinement \cite{dickson2024trust}.
This process mirrors how humans develop complex arguments: through step-by-step reasoning where each step builds on and maintains the computational state established by previous steps.
