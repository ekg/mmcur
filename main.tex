...
Even systems with very basic state transitions can achieve universal computation when equipped with memory~\cite{merrill2023parallelism,peng2024limitations}.
This principle, demonstrated by minimal universal systems like Rule 110 cellular automata~\cite{cook2004universality}, echoes across all information processing systems, from cells to civilizations to silicon.
