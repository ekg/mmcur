...
Recent theoretical and empirical work with transformers and large language models reveals how memory enables systems to transcend fundamental computational limitations \cite{merrill2024,schuurmans2024autoregressive}. These models, despite their sophisticated architectures, are fundamentally constrained to threshold circuits by parallel processing requirements \cite{merrill2023parallelism}. Yet through mechanisms like chain-of-thought reasoning that maintain state across multiple steps, they achieve complex sequential computation previously thought beyond their capabilities \cite{wei2022chain,qiu2024ask}. This pattern appears across domains - from neural networks to biological cells \cite{fu2023scgrn,hoel2020emergence}, systems achieve universal computation not through more complex processing units, but through memory mechanisms that maintain and access computational state.

This perspective helps explain computation in practice. In artificial systems, techniques like chain-of-thought prompting improve reasoning capabilities by providing a framework for memory-based recursive computation \cite{wei2022chain,dickson2024trust,ahn2024recursive,qiu2024ask}. The amount of computational power gained depends crucially on the number of intermediate reasoning steps allowed \cite{merrill2024}. In biological systems, organisms achieve complex information processing through diverse memory structures, from neural synapses to developmental patterns and genomic evolution \cite{burrill2010making,espinosa2024molecular}.
