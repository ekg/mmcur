...
In the hippocampal-entorhinal circuit, ``time cells'' fire sequentially to encode distinct moments in time, while ramping cells bridge these moments by changing their firing patterns as the interval progresses \cite{quentin2019differential}.
Simultaneously, the prefrontal cortex and parahippocampal regions integrate contextual details \cite{martini2015information}, ensuring ordered, coherent episodic memories without requiring each neuron to act as a purely sequential processor.
