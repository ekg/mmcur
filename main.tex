...
Language models achieve step-by-step reasoning by using prompts as memory, maintaining computational state across multiple steps---no complex architecture required.
