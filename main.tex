...
\section{From simple operations to universal computation}

To illustrate how the proof shows memory transforming simple operations into universal computation, consider a basic threshold unit that checks if a number is greater than zero.
