...
The system achieves 82.8\% accuracy on 400 public tasks in high-efficiency mode (costing \$6{,}677 and using roughly 33M tokens) and 91.5\% in low-efficiency mode (costing \$1.15M and using around 9.5B tokens) \cite{chollet2024o3}.
