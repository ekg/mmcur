...
While we can engineer silicon chips to perform computation by precisely controlling electromagnetic flows through crystalline structures, biological systems had to solve computational problems through inherently "blobby, wet" parallel molecular mechanisms \cite{fu2023scgrn}.
This parallel architecture---where computation emerges from countless simultaneous molecular interactions, from neural networks optimized for multi-device training to cellular molecular networks---fundamentally constrains such systems to threshold circuits \cite{merrill2023parallelism,merrill2024}.
