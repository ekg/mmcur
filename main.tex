...
Yet this insight points to something deeper.
Just as biological systems evolved increasingly sophisticated memory mechanisms---from cellular state to neural architectures---human civilization has advanced through similar transformations in its ability to maintain and access computational state.
From oral traditions carefully preserving knowledge across generations, to writing systems extending our collective memory, to modern computing architectures maintaining billions of precise states, our computational capabilities have grown in lockstep with our ability to remember.
The fundamental role of memory in enabling universal computation appears, perhaps appropriately enough, worth remembering.

This theoretical framework suggests a shift in focus for AI development.
...
By returning to these fundamental requirements of computation, we gain insight into both the current limitations and future directions of artificial intelligence, while deepening our understanding of computation across both artificial and biological systems---remember?
