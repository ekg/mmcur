...
This theoretical framework unifies our understanding of computation across minds, machines, and living systems.
Through exposure to human knowledge, language models learn patterns of state maintenance embedded in language.
This demonstrates a fundamental principle: memory mechanisms enable universal computation in both biological and artificial systems.
\end{abstract}
